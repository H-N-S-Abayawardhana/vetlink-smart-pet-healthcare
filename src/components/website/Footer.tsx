        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {/* Facebook */}
              <a
                href="https://facebook.com/vetlink"
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl p-2 text-gray-300 hover:text-slate-50 hover:bg-white/5 transition-all cursor-pointer ring-1 ring-transparent hover:ring-white/10 hover:shadow-[0_0_0_1px_rgba(0,229,255,0.18),0_14px_30px_-18px_rgba(0,229,255,0.35)]"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
              ...
              {/* X (Twitter) */}
              <a
                href="https://x.com/vetlink"
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl p-2 text-gray-300 hover:text-slate-50 hover:bg-white/5 transition-all cursor-pointer ring-1 ring-transparent hover:ring-white/10 hover:shadow-[0_0_0_1px_rgba(45,212,191,0.18),0_14px_30px_-18px_rgba(45,212,191,0.35)]"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
