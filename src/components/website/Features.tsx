    ...
    <section id="features" className="py-16 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-2">
            <div className="text-center">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Skin Care Detection</h3>
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-2">
            <div className="text-center">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Anomaly Detection</h3>
              <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4 leading-relaxed">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-2">
            <div className="text-center">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">AI Diet Plans</h3>
              <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4 leading-relaxed">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-2">
            <div className="text-center">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Intelligent Pharmacy</h3>
              <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4 leading-relaxed">
