        ...
        <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
          {!dashboard ? (
            ...
            <>
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div className="bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl p-6 shadow-xl text-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      ...
                      >
                        ...
                        <div className="text-xs text-emerald-100 mt-1">View available medications</div>
                      </button>
                      <button
                      ...
                      >
                        ...
                        <div className="text-xs text-emerald-100 mt-1">Sales & performance data</div>
                      </button>
                    </div>
                  </div>
                      ...
                      <div key={idx} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className={`text-xs font-semibold px-2 py-1 rounded-full ${
                            ...
                            stat.change.includes('Low') ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-700'
                          }`}>
                            {stat.change}
                          </div>
                        </div>
                  ...
                  <div className="grid gap-6 lg:grid-cols-3">
                    <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                      ...
                      <SalesChart values={dashboard.chart?.values || []} labels={dashboard.chart?.labels || []} />
                      ...
                      <div className="mt-6 bg-white rounded-2xl p-4 border border-gray-100 shadow-sm">
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-md font-semibold text-gray-900 flex items-center gap-2">💡 Business improvement suggestions</h4>
                          <div className="text-xs text-gray-400">Future: populated by ML</div>
                        </div>

                        <div className="text-sm text-gray-600">
                          <p className="mb-2">Suggestions will appear here after analyzing sales, inventory and demand — this section is a placeholder for now.</p>
                          <ul className="list-disc pl-5 space-y-1 text-gray-700">
                            <li><strong>No suggestions yet.</strong> ML model integration will populate recommendations here later.</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="lg:col-span-1 space-y-6">
                      ...
                      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                        ...
                        <RecentSales sales={(dashboard.recent || []).slice(0, 5)} />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Inventory Tab */}
              {activeTab === 'inventory' && (
                <div className="space-y-6 animate-fadeIn" id="pharmacy-inventory">
                  <div className="bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl p-6 shadow-xl text-white">
                    <h3 className="text-xl font-bold mb-2 flex items-center gap-2">
                      <span>📦</span>
                      Inventory Management
                    </h3>
                    <p className="text-blue-100 text-sm">Browse, search, and manage all pharmacy products</p>
                  </div>
                  <InventoryList />
                </div>
              )}
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                      ...
                      <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
                        <h4 className="font-semibold text-purple-900 mb-3">Top Performing Items</h4>
                        <TopProducts products={dashboard.top || []} />
                      </div>
                    </div>
                  </div>
